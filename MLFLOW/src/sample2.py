# the link copied from dagshub repo
...
# Inititalize dagshub
dagshub.init(repo_owner='gsidique37', repo_name='MLOps', mlflow=True)

# set a tracking ui for mlflow
mlflow.set_tracking_uri("https://dagshub.com/gsidique37/MLOps.mlflow")
